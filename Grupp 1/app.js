        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Helper.fetchContent("template/" + name + "-template.html")];
                case 1:
                    content = _a.sent();
                    if (content) {
...
var App = /** @class */ (function () {
    function App() {
        this._mainNavLinks = [{ name: "Acquire item", link: "#acquire/item" },
            { name: "Provide item", link: "#provide/item" },
            { name: "Acquire service", link: "#acquire/service" },
            { name: "Provide service", link: "#provide/service" }];
        this._navLinks = [];
        this._page;
        this._navLinks = this._mainNavLinks.slice(); // ", ...this._footerNavLinks, ...this._mainNavLinks"
        this._bindEvents();
        this._setup();
    }
